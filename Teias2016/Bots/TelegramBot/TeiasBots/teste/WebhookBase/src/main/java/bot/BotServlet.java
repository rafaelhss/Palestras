...
public class BotServlet extends HttpServlet {
  ...
  public void processRequest(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    try (PrintWriter out = resp.getWriter()) {
        ...
        out.println("<h1>Bot Servlet ao seu dispor!</h1>");
        ...
        new bot.sender.Sender("225779469:AAEB6m12LCsREqUgCSU0lt9WtRUPopEVZY8").sendResponse(c.getMessage().getFrom().getId(), "Oi, sou o teiasBot! voce disse:" + c.getMessage().getText());
    }
  }
